...
public class GCContentFitness implements FitnessStrategy {
     ...
     *
     * Preconditions:
     * - The virus object must have a non-null genome.
     * - Genome segments should contain only valid bases (A, U, G, C).
     *
     * Postconditions:
     * - Returns a fitness score between 0.0 and 1.0, inclusive.
     * - The fitness score is based on the proportion of GC bases in the genome.
     *
